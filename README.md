...
# Airfortress.py  ![alt tag](http://icons.iconarchive.com/icons/icons8/ios7/48/Network-Wifi-Logo-icon.png)
...
2) sudo git clone https://github.com/swapneshyt-Dark/Airfortress.git
3) cd Airfortress/
4) sudo python3 Airfortress.py
```
